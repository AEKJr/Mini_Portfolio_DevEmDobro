...
o conteúdo da aba no qual foi clicada pelo usuário e 
...
function mostrarInformacaoDaAba(aba){
    // passo 5
    const informarcaoSelecionada = document.querySelector(".informacao.selecionado");
    informarcaoSelecionada.classList.remove("selecionado");
    // passo 6
